...
exports.run = function(client, message, args) {
  ...
  .setColor("PURPLE")
  .setDescription(`<a:evet:823495530843865139> ${message.author} adlı kullanıcının <@${botid}> adlı botu sıraya ekledi. Botu onaylanmayı bekliyor. `)
  ...
  message.channel.send(` <a:evet:823495530843865139> Bot ekleme isteğiniz alındı.`).then(msg => msg.delete(1000))
  }
};
////fiber botlist & code
exports.conf = {
