...
exports.run = function(client, message, args) {
  ...
  .setColor("GREEN")
  .setDescription(`<a:evet:823495530843865139> <@${sahip}> adlı kişinin <@${botisim}> adlı botu onaylandı.\nOnaylayan yetkili : ${message.author}`)
  ...
  message.channel.send(`<a:evet:823495530843865139> Botu onayladınız.`).then(msg => msg.delete(1000))
